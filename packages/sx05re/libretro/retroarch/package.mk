...
if [ "$DEVICE" == "OdroidGoAdvance" ]; then
  ...
  # Vib
  sed -i -e "s/# vibrate_on_keypress = false/vibrate_on_keypress = true/" $INSTALL/etc/retroarch.cfg
  ...
  sed -i -e "s/# input_player1_start_btn =/input_player1_start_btn = 21/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_select_btn =/input_player1_select_btn = 22/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_a_btn =/input_player1_a_btn = 15/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_b_btn =/input_player1_b_btn = 16/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_down_btn =/input_player1_down_btn = h0down/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_l2_btn =/input_player1_l2_btn = 25/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_l3_btn =/input_player1_l3_btn = 23/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_l_btn =/input_player1_l_btn = 19/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_left_btn =/input_player1_left_btn = h0left/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_r2_btn =/input_player1_r2_btn = 26/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_r3_btn =/input_player1_r3_btn = 24/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_r_btn =/input_player1_r_btn = 20/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_right_btn =/input_player1_right_btn = h0right/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_up_btn =/input_player1_up_btn = h0up/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_x_btn =/input_player1_x_btn = 17/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_player1_y_btn =/input_player1_y_btn = 18/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# input_enable_hotkey_btn =/input_enable_hotkey_btn = 24/" $INSTALL/etc/retroarch.cfg
  sed -i -e "s/# aspect_ratio_index = 19/aspect_ratio_index = 7/" $INSTALL/etc/retroarch.cfg
  echo "xmb_font = /usr/share/retroarch-assets/xmb/monochrome/font.ttf" >> $INSTALL/etc/retroarch.cfg
  echo "input_fps_toggle_btn = \"26\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_load_state_btn = \"19\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_save_state_btn = \"20\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_toggle_fast_forward_btn = \"25\"" >> $INSTALL/etc/retroarch.cfg
  echo "ai_service_enable = \"false\"" >> $INSTALL/etc/retroarch.cfg
  echo "custom_viewport_height = \"320\"" >> $INSTALL/etc/retroarch.cfg
  echo "custom_viewport_width = \"356\"" >> $INSTALL/etc/retroarch.cfg
  echo "custom_viewport_x = \"62\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_l_x_plus_axis = \"-0\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_l_x_minus_axis = \"+0\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_l_y_plus_axis = \"-1\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_l_y_minus_axis = \"+1\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_r_x_plus_axis = \"+2\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_r_x_minus_axis = \"-2\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_r_y_plus_axis = \"+3\"" >> $INSTALL/etc/retroarch.cfg
  echo "input_player1_r_y_minus_axis = \"-3\"" >> $INSTALL/etc/retroarch.cfg
