...
PKG_TOOLS="ffmpeg libjpeg-turbo common-shaders Skyscraper MC libretro-bash-launcher SDL_GameControllerDB linux-utils xmlstarlet CoreELEC-Debug-Scripts sixaxis jslisten evtest mpv poppler bluetool"
...
if [ "${PROJECT}" != "Amlogic-ng" ]; then
  ...
  # Remove scripts from OdroidGoAdvance build
	if [[ ${DEVICE} == "OdroidGoAdvance" ]]; then 
	for i in "01 - Get ES Themes" "03 - wifi" "10 - Force Update" "04 - Configure Reicast" "07 - Skyscraper" "09 - system info" "15 - Bluetooth controller management"; do 
